...
**Twitter Client - Part 2** is an android app that allows a user to view his Twitter timeline and post a new tweet. The app utilizes [Twitter REST API](https://dev.twitter.com/rest/public).
...
<img src='https://github.com/valfranceau/TwitterClient_2/blob/master/MyVideo_1.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
